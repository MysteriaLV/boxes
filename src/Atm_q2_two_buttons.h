...
class Atm_q2_two_buttons : public Machine {
...
public:
    ...
    Atm_q2_two_buttons(void) : Machine() {};

    Atm_q2_two_buttons &begin();
    Atm_q2_two_buttons &trace(Stream &stream);
    Atm_q2_two_buttons &trigger(int event);
    int state(void);
    Atm_q2_two_buttons &onFinished(Machine &machine, int event = 0);
    Atm_q2_two_buttons &onFinished(atm_cb_push_t callback, int idx = 0);
    Atm_q2_two_buttons &make_progress(void);
    Atm_q2_two_buttons &wrong_move(void);
...
<machines>
  <machine name="Atm_q2_two_buttons">
    <states>
